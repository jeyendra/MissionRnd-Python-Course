...
def test_inheritance_init():
    ...
    assert AttributeError,'a.b1 not found' == getattr(a, "b1", None)

    b = B()
    assert AttributeError,'b.a1 oveeridden' == getattr(b, "a1", None)
    ...
    b = B()
    assert AttributeError,'b.a1 not found' == getattr(b, "a1", None)
