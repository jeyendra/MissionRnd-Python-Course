...
def test_function_call_with_keyword_arguments():
    ...
    assert [10,10,30,4] == demo(first=10,second=10,third=30)
    assert [10,20,30,4] == demo(10,20, third=30)
    assert [10,20,10,4] == demo(10,second=20,third=10)  # is this allowed? yes correct and uncomment
...
def test_function_with_keyword_args():
    ...
    assert { } == demo_with_keyword_args(name="jack") # what do you observe here? it returns a empty dict
